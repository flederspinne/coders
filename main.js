...
// TODO: Визуализация!
// TODO: Запускать действия сотрудников параллельно (по функции на каждого, всё равно JS асинхронный).
// TODO: Ввести защиту от ввода некорректных данных.

// TODO: Общаться сотрудник может только тогда, когда кроме него есть ещё кто-то. Разговаривать должен не один.s